          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Article - Size</h4>
                ...
                <form id="post_" data-parsley-validate class="form-horizontal form-label-left">
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      ...
                      <input type="hidden" name="ArticleTable" id="ArticleTable" value="articlesize">
                    </div>
                  </div>
                  <div class="item form-group">
  ...
  $(function () {
    $(document).ready(function () {
      ...
      $.ajax({
        ...
        data: {'ArticleCode':'','ArticleTable':'articlesize'},
        dataType: "json",
    ...
    function GetData(id) {
      ...
      $.ajax({
            type: "post",
            url: "<?=base_url()?>C_Article/Read",
            data: {'ArticleCode':id,'ArticleTable':'articlesize'},
            dataType: "json",
            success: function (response) {
        ...
        allowColumnResizing: true,
            ...
            onInitNewRow: function(e) {
                ...
                $.ajax({
                  ...
                  data: {'Kolom':'ArticleCode','Table':'articlesize','Prefix':'3'},
                  dataType: "json",
                  success: function (response) {
                    // bindGrid(response.data);
              ...
              Swal.fire({
                ...
                if (result.value) {
                  ...
                  $.ajax({
                      type    :'post',
                      url     : '<?=base_url()?>C_Article/CRUD',
                      data    : {'ArticleCode':id,'formtype':'delete','ArticleTable':'articlesize'},
                      dataType: 'json',
                      success : function (response) {
                        if(response.success == true){
                          Swal.fire(
