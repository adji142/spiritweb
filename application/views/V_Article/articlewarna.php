                ...
                <form id="post_" data-parsley-validate class="form-horizontal form-label-left">
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      ...
                      <input type="hidden" name="ArticleTable" id="ArticleTable" value="articlewarna">
                    </div>
                  </div>
                  <div class="item form-group">
  ...
  $(function () {
    $(document).ready(function () {
      ...
      $.ajax({
        ...
        data: {'ArticleCode':'','ArticleTable':'articlewarna'},
        dataType: "json",
    ...
    function GetData(id) {
      ...
      $.ajax({
            type: "post",
            url: "<?=base_url()?>C_Article/Read",
            data: {'ArticleCode':id,'ArticleTable':'articlewarna'},
            dataType: "json",
            success: function (response) {
        ...
        allowColumnResizing: true,
            ...
            onInitNewRow: function(e) {
                ...
                $.ajax({
                  ...
                  data: {'Kolom':'ArticleCode','Table':'articlewarna','Prefix':'1'},
                  dataType: "json",
                  success: function (response) {
                    // bindGrid(response.data);
              ...
              Swal.fire({
                ...
                if (result.value) {
                  ...
                  $.ajax({
                      type    :'post',
                      url     : '<?=base_url()?>C_Article/CRUD',
                      data    : {'ArticleCode':id,'formtype':'delete','ArticleTable':'articlewarna'},
                      dataType: 'json',
                      success : function (response) {
                        if(response.success == true){
                          Swal.fire(
